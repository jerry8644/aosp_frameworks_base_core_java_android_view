...
oneway interface IWindow {
    ...
    /**
     * Tell the window that resizing is enabled
     */
    void dispatchResolutionChanged(boolean isResizeEnabled, float scaleFactor, int frameTime);

    /**
     * Output the display list of current focused view
     */
    void outputInfo(in FileDescriptor fd);

    /**
     * Set a divisor between the current Vsync and the next Vsync 
     */
    void setFrameRate(int divisor); 

    /**
     * Tell the window to switch displaying mode
     */
    void dispatchModeChanged(float scaleFactor, int frameTime, int divisor);
